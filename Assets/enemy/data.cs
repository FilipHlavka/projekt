...
public class data : MonoBehaviour
{
    ...
    public void Start()
    {
        gameObject.GetComponent<pohybEnemy>().agent.speed = rychlost;
        gameObject.GetComponent<pohybEnemy>().AtkRange = range;
        gameObject.GetComponent<pohybEnemy>().dosahDetekce = dosahDetekce;
